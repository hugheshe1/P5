                ...
                try
                {
                    ...
                    switch (selection)
                    {
                        ...
                        case 1:
                            ...
                            {
                                WriteLine("Invalid entry. Please enter an integer.");
                                response = ReadLine();
                            }

                            tree = new BTree(Convert.ToInt32(response));
                            FillTree();
                        ...
                        case 3:
                            ...
                            if (tree.AddValue(Convert.ToInt32(response)))
                            {
                        ...
                        case 4:
                            ...
                            Leaf leaf = null;
                            bool match = tree.FindValue(Convert.ToInt32(response), out leaf);
